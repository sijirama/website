        ...
        <section className=' px-5 h-full overflow-y-auto'>
...

            {
                !fileContent ? ("No data yet") : (
                    <article
                        className={`md:max-w-4xl lg:max-w-7xl 3xl:max-w-5xl mx-auto prose prose-stone prose-headings:${manrope.className} prose-p:${manrope.className} prose-li:${manrope.className} prose-li:text-zinc-900 dark:prose-li:text-zinc-300 prose-li:text-xs  lg:prose-li:text-base max-w-none mx-auto prose-code:bg-zinc-400 prose-a:p-1 prose-a:rounded-lg prose-a:bg-zinc-300 dark:prose-a:bg-[#2C2f32] prose-a:text-[#5d7da5]  prose-code:py-0.5 prose-code:rounded-md prose-pre:bg-zinc-50 prose-p:text-xs lg:prose-p:text-base prose-p:text-zinc-900 dark:prose-p:text-zinc-300 prose-headings:text-lg md:prose-headings:text-2xl prose-headings:text-zinc-900 dark:prose-headings:text-zinc-100`}
                    >
