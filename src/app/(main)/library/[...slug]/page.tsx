        ...
        <section className=' px-5 h-full overflow-y-auto'>
...

            {
                !fileContent ? ("No data yet") : (
                    <article
                        className={`md:max-w-4xl lg:max-w-4xl 3xl:max-w-5xl  mx-auto prose prose-stone prose-headings:${manrope.className} prose-p:${manrope.className} prose-li:${manrope.className} prose-li:text-zinc-900 dark:prose-li:text-zinc-300 prose-li:text-sm lg:prose-li:text-base max-w-none mx-auto prose-code:bg-zinc-400 prose-a:dark:text-zinc-300  prose-code:py-0.5 prose-code:rounded-md prose-pre:bg-zinc-50 prose-p:text-sm prose-p:text-zinc-900 dark:prose-p:text-zinc-300 md:prose-p:text-base prose-headings:text-lg md:prose-headings:text-2xl prose-headings:text-zinc-900 dark:prose-headings:text-zinc-100`}
                    >
