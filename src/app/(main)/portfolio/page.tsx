...
export default function Page() {
  ...
  const socials = [
    ...
    {
      icon: <FaRegFile className={`${iconStyle}`} />,
      url: "https://flowcv.com/resume/qjwdae4u1j",
    },
  ];
    ...
    >
      ...
      <div className="text-start  w-full flex flex-col gap-2">
        ...
        <p className="text-xs md:text-base tracking-wide text-zinc-900 dark:text-zinc-100">
          ...
          meaningful solutions. Whether it is bringing ideas to life or leading
          collaborative efforts.
        </p>
      </div>
      <img
        className="w-full my-5"
        src="http://ghchart.rshah.org/sijirama"
        alt="sijirama's Github chart"
      />
      ...
      <div className="w-full">
        <p className="font-extrabold -tracking-wide text-lg mb-6">
          Current Projects
        </p>
