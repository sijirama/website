...
export default function About() {
    ...
    return (
        <main
            className={`min-h-screen items-center -tracking-wide bg-black ${manrope.className} flex flex-col justify-center text-zinc-400`}
        >
            {/* info side */}
            <div className="h-full w-full md:w-2/3 lg:w-2/5 row-span-4 flex flex-col items-center justify-center px-5 gap-2 -tracking-wide ">
                {/* title side */}
                <div
