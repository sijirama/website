...
export function MiniPortfolio() {
    ...
    return (
        <section className={`flex-1 ${manrope.className} text-xs lg:text-sm md:w-[95%] mx-auto flex flex-col gap-5 my-3 py-6 border-t-zinc-400 dark:border-t-zinc-700 border-t-[0.1px] text-zinc-900 dark:text-zinc-300 `}>
