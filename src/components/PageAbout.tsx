...
export default function JobHunt() {
    return <section className="w-full h-full bg-black text-zinc-400 items-center flex px-1 md:px-5 mx-auto">
        <div className=" w-full md:w-5/6 flex items-center h-full md:py-5">
            <p id='target' className={`${manrope.className} text-sm md:text-xl`} >
